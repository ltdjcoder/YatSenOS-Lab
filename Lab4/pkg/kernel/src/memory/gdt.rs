...
pub const SYSCALL_INTERRUPT_IST_INDEX: u16 = 3;
...
lazy_static! {
    static ref TSS: TaskStateSegment = {
        ...
        // FIX-ME: fill tss.interrupt_stack_table with the static stack buffers like above
        ...
        tss.interrupt_stack_table[0] = {
            ...
            let stack_end = stack_start + STACK_SIZE as u64;
            info!(
                "interrupt Stack  : 0x{:016x}-0x{:016x}",
                stack_start.as_u64(),
                stack_end.as_u64()
            );
            stack_end
